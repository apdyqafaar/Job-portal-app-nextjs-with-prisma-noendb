...
CREATE TABLE "public"."Job" (
    ...
    "locstion" TEXT NOT NULL,
    "type" TEXT NOT NULL,
    "description" TEXT NOT NULL,
    "salary" TEXT,
    "postedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "psotedById" TEXT NOT NULL,
...
CREATE TABLE "public"."Application" (
    ...
    "apdatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "public"."Job" ADD CONSTRAINT "Job_psotedById_fkey" FOREIGN KEY ("psotedById") REFERENCES "public"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
