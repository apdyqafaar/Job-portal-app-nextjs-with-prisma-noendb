...
const Signin = () => {
  ...
  return (
    <div className='min-h-[600px] flex items-center justify-center'>
      ...
      <CardHeader>
        <CardTitle>Welcome to the Job fire</CardTitle>
        <CardDescription>
         Sigin to post jobs for application
        </CardDescription>
        <CardAction>
        </CardAction>
      </CardHeader>
  ...
  1.305 3.495.998.108-.776.418-1.305.762-1.605 
  ...
  1.23 1.911 1.23 3.221 
  0 4.61-2.805 5.625-5.475 5.92.435.375.81 
  ...
  Continue with Github
          ...
          <p className="text-muted-foreground text-sm mt-6">If you dont have an account? <Link href={"#"} className='text-orange-600'>Sing up</Link> </p>
      </CardFooter>
    </Card>
    </div>
  )
